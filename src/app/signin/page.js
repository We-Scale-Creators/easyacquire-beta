  ...
  return (
    <div className="min-h-screen bg-[#0B1A33] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#4F79FF] to-[#3C53E4]" />
        <div className="absolute inset-0 bg-[url('/grid.svg')] opacity-10" />

        {/* Floating Elements */}
        <div className="absolute top-20 left-20 w-32 h-32 bg-white/10 rounded-3xl backdrop-blur-xl animate-float" />
        <div className="absolute bottom-40 right-20 w-24 h-24 bg-white/10 rounded-2xl backdrop-blur-xl animate-float-delayed" />
        <div className="absolute top-1/2 left-1/3 w-16 h-16 bg-white/10 rounded-xl backdrop-blur-xl animate-float" />
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold text-white mb-4">EasyAcquire.ai</h1>
            <p className="text-xl text-white/80 leading-relaxed max-w-md">
              Your AI-powered business acquisition platform. Find, analyze, and acquire your perfect business.
            </p>
          </div>

          <div className="space-y-6 mt-12">
            {[
              { icon: '🎯', text: 'AI-powered deal analysis' },
              { icon: '📊', text: 'Real-time market intelligence' },
              { icon: '🤝', text: 'Expert acquisition support' }
            ].map((feature, index) => (
      ...
      <div className="flex-1 flex items-center justify-center px-8 py-12">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/forgot-password" className="text-sm text-[#4F79FF] hover:text-[#3C53E4] transition-colors">
                  Forgot password?
                </Link>
              </div>
              <input
            ...
            <div className="flex items-center gap-3">
              <input
                type="checkbox"
                id="remember"
                className="w-4 h-4 rounded accent-[#4F79FF]"
              />
          ...
          <p className="text-center text-gray-400 mt-8">
            ...
            <Link href="/signup" className="text-[#4F79FF] font-semibold hover:text-[#3C53E4] transition-colors">
              Sign up free
            </Link>
          </p>
        </div>
